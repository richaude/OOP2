...
/**
 * Klasse Spiegelzahl: Erzeugt von einer übergebenen Zahl die Spiegelzahl und kann diese auf die Palindromeigenschaft pruefen sowie Summe errechnen
 * @author Lukas
 * @version 2.0
 */
...
public class Spiegelzahl {
	...
	public List<Byte> addiere() {
		...
		// Initialisiere Byte-Array, eins länger als die anderen beiden Zahlen!
	 ...
	 * @return Eine Byte-Liste mit den einzelnen Stellen der Spiegelzahl
	 */
	public List<Byte> getSpiegelzahl() {
		return this.spiegelzahl;
	}	
}
